...
namespace AlistarMaster.Modes
{
    public sealed class Combo : ModeBase
    {
        ...
        public override void Execute()
        {
            ...
            if(Settings.comboQW == false && Settings.UseQ && Q.IsReady() && target.IsValidTarget(Q.Range))
            {
                Q.Cast();
            }

            if (Settings.comboQW == false && Settings.UseW && W.IsReady() && target.IsValidTarget(W.Range))
            {
                W.Cast(target);
            }
        }
