...
namespace AlistarMaster.Modes
{
    public sealed class Harass : ModeBase
    {
        ...
        public override void Execute()
        {
            ...
            if (W.IsReady() && Q.IsReady() && target.IsValidTarget(W.Range))
            {
            ...
            if (Config.Modes.Combo.comboQW == false && Settings.UseQ && Q.IsReady() && target.IsValidTarget(Q.Range))
            {
                Q.Cast();
            }

            if (Config.Modes.Combo.comboQW == false && Settings.UseW && W.IsReady() && target.IsValidTarget(W.Range))
            {
                W.Cast(target);
            }
        }
